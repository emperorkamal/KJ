...
public class SilverItemsDao extends MySQLAccess {
    ...
    public ArrayList<Items> buildItem() throws Exception {
        ...
        try {
            ...
            String sql = "SELECT * FROM SILVER_ITEM";
    ...
    public ArrayList<SoldItems> buildSoldItem() throws Exception {
        ...
        try {
            ...
            String sql = "SELECT * FROM SILVER_SOLD_ITEM";
            PreparedStatement ps = conn.prepareStatement(sql);
    ...
    public void deleteSoldItem(int id) throws SQLException {
        try {
            Connection conn;
            conn = getConnection();
            String sql = "delete from kj.silver_sold_item where id= ? ; ";
            PreparedStatement ps = conn.prepareStatement(sql);
            ps.setInt(1, id);
            ps.executeUpdate();
            ps.close();
     ...
     public void insertSoldItem(SoldItems sold_item) throws SQLException {
        ...
        try {
            Connection conn = getConnection();
            String sql = "insert into silver_sold_item select max(sold_id)+1,?,?,?,?,?,?,?,?,?,?,?,?,?,?,? from sold_item";
            PreparedStatement ps = conn.prepareStatement(sql);
