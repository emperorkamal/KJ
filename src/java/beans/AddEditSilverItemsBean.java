...
@Named("addEditSilverItemsBean")
@ViewScoped
public class AddEditSilverItemsBean implements Serializable {

    private final SilverItemsDao ItemsDao = new SilverItemsDao();
    private int id;
    ...
    private final SilverItemDetailsDao itemDetailsDao = new SilverItemDetailsDao();

    @Inject
    private beans.SessionBean sessionBean;

    public AddEditSilverItemsBean() {
    }
    ...
    public void init() {
       int item_id=sessionBean.getSelectedItemId();
        try {
            ...
            Logger.getLogger(AddEditSilverItemsBean.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
